...
export const stripeProducts = mysqlTable("stripeProducts", {
  ...
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  index: index("idx_stripeProductId").on("stripeProductId"),
});
...
export const stripePrices = mysqlTable("stripePrices", {
  ...
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  index: index("idx_stripePriceId").on("stripePriceId"),
  index2: index("idx_stripeProductId_price").on("stripeProductId"),
});
...
export const stripeSubscriptions = mysqlTable("stripeSubscriptions", {
  ...
  status: varchar("status", { length: 50 }).notNull(), // active, past_due, unpaid, canceled, incomplete
  currentPeriodStart: timestamp("currentPeriodStart"),
  currentPeriodEnd: timestamp("currentPeriodEnd"),
  cancelledAt: timestamp("cancelledAt"),
  ...
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  index: index("idx_userId_subscription").on("userId"),
  index2: index("idx_stripeSubscriptionId").on("stripeSubscriptionId"),
});
...
export const stripeCustomers = mysqlTable("stripeCustomers", {
  ...
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
  index: index("idx_stripeCustomerId").on("stripeCustomerId"),
});
