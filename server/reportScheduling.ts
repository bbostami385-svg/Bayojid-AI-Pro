...
/**
 * Get scheduled report by ID (tRPC compatibility)
 */
...
/**
 * Get user scheduled reports (tRPC compatibility)
 */
...
/**
 * Get generated reports (tRPC compatibility)
 */
export function getGeneratedReports(
  userId: number,
  limit: number = 50,
...
/**
 * Create scheduled report (tRPC compatibility)
 */
...
/**
 * Update scheduled report (tRPC compatibility)
 */
export function updateScheduledReport(
  reportId: string,
  updates: Partial<ScheduledReport>
...
/**
 * Delete scheduled report (tRPC compatibility)
 */
export function deleteScheduledReport(reportId: string): boolean {
...
/**
 * Get report statistics (tRPC compatibility)
 */
